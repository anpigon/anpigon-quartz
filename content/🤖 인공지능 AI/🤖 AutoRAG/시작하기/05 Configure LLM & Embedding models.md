...
- [llama_index_llm](llama_index_llm.md)

The following modules can use generator module, which including `llama_index_llm`.

- [hyde](hyde.md)
- [query_decompose](query_decompose.md)
- [multi_query_expansion](multi_query_expansion.md)
- [tree_summarize](tree_summarize.md)
...
You can use vllm to use local LLM. For more information, please check out [vllm](vllm.md) generator
module docs.