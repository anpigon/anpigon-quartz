---
title: "📈 정보 검색 성능 측정: 순위 미고려 지표(Rank-Unaware) - Precision, Recall, F1-Score"
created: 2025-05-06 10:16:15
updated: 2025-05-06 10:47:02
---
정보 검색(Information Retrieval, IR) 시스템이나 추천 시스템, 기계 학습 모델의 성능을 평가하는 것은 매우 중요합니다. 특히 검색된 결과의 **순서를 고려하지 않고** 단순히 '얼마나 관련 있는 항목을 잘 찾아냈는가'를 평가하는 기본적인 지표로 **Precision(정밀도)**, **Recall(재현율)**, 그리고 이 둘의 조화 평균인 **F1-Score**가 널리 사용됩니다. 이 노트에서는 각 지표의 정의, 의미, 계산 방법, 그리고 장단점을 자세히 살펴보겠습니다. 🤔
