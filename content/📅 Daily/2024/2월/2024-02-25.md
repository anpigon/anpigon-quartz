...
## Resources
- #rag [한국어 자연어처리 1편_서브워드 구축(Subword Tokenizer, Mecab,  huggingface VS SentencePiece)](https://keep-steady.tistory.com/37)
...
- #llm/한국어 https://github.com/42dot/42dot_LLM: 1.3B 한국어 모델.  llama.cpp에서도 구동 가능함.
