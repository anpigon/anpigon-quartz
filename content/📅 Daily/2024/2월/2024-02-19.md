...
- #메모/세컨드브레인
	- 내가 작성한 메모를 다시 꺼내보는 방법 → 옵시디언 메모를 벡터화하여, 내가 제기한 질문에 적합한 답변을 내가 작성한 메모에서 찾아주는 방식이 유용할 것 같다.
		- [[🪴 Digital Garden/📅 Daily/2024/2월/2024-02-14#^mxac|AutoRAG: 자동으로 최적의 RAG 파이프라인을 찾아주는 자동화 툴 | GeekNews]]를 참조하여 구현해 보는 것을 고려해 볼 수 있다.
		- 임베딩 모델:
...
- #오픈소스
	...
	- [Zed Extensions](https://github.com/zed-industries/extensions): Zed 편집기용 확장 기능
		- **Links:**
			- [[🪴 Digital Garden/📅 Daily/2024/2월/2024-02-18#^j5rb|Reviewing Zed: An IDE of the Future]]
