...
- #개발 [소프트웨어 개발에서 배운 교훈들 | GeekNews](https://news.hada.io/topic?id=13641)
	- [[소프트웨어 개발 교훈]]
- #python [FastUI: 파이썬으로 더 빠르고 좋은 웹 UI 만들기  | GeekNews](https://news.hada.io/topic?id=13619)
- #개발 [스타트업에서 4년간 인프라를 운영하며 좋았던/후회하는 (거의) 모든 인프라 결정들 | GeekNews](https://news.hada.io/topic?id=13564)
- #css [CSS :has() Interactive Guide](https://ishadeed.com/article/css-has-guide)
